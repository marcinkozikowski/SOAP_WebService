 ...
 * 
 */
@WebServiceClient(name = "HelloWorldImplService", targetNamespace = "http://rsi.jg.org/", wsdlLocation = "http://localhost:8080/WebServiceGlass/HelloWorldImplService?WSDL")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/WebServiceGlass/HelloWorldImplService?WSDL");
